...
#include "/Users/noah/Physics/James_Research/ILC_PhotonFusion/roofit.C"
...
struct HypoTestInvOptions {
   ...
   bool generateBinned = true; // generate binned data sets ////////THIS WAS FALSE AS DEFAULT NOAH
   ...
   int nAsimovBins = 200; // number of bins in observables used for Asimov data sets (0 is the default and it is given by
...
public:
   ...
   HypoTestInverterResult *RunInverter(RooWorkspace *w, const char *modelSBName, const char *modelBName,
                                       ...
                                       double poimin, double poimax, bool dolog, int ntoys, bool useNumberCounting = false,
...
void StandardHypoTestInvDemo(double mass_value = 30.0, const char *infile = 0, const char *wsName = "combined",
                             ...
                             bool useCLs = true, int npoints = 6, double poimin = 0, double poimax = 5, bool dolog = false, 
   ...
   */
   ...
   if (w != NULL) {
      r = calc.RunInverter(w, modelSBName, modelBName, dataName, calculatorType, testStatType, useCLs, npoints, poimin,
                           poimax, dolog, ntoys, useNumberCounting, nuisPriorName);
      if (!r) {
...
HypoTestInverterResult *RooStats::HypoTestInvTool::RunInverter(RooWorkspace *w, const char *modelSBName,
                                                               ...
                                                               double poimin, double poimax, bool dolog, int ntoys,
                                                               bool useNumberCounting, const char *nuisPriorName)
{
   ...
   if (npoints > 0) {
      ...
      calc.SetFixedScan(npoints, poimin, poimax, dolog);
   } else {
