...
// ********************************************************************
//
#include "g4PSIBOptrChangeCrossSection.hh"
...
//    G4ThreeVector p_in = track->GetStep()->GetPostStepPoint()->GetMomentumDirection();
//    G4ThreeVector p_out = track->GetStep()->GetPostStepPoint()->GetMomentumDirection();
//    G4double theta = acos(p_in * p_out) * 180. / 3.14159;
//    std::cout << callingProcess->GetProcessName() << std::endl;
//    if (theta > 0) {
//        std::cout << callingProcess->GetProcessName() << " " <<
//        "Theta = " << theta << " " << p_in << " " << p_out << std::endl;
//    }
    G4double XStransformation = g4PSIAnalysisManager::getInstance()->GetBiasingPhysicsScale();
 ; // was 2.0
