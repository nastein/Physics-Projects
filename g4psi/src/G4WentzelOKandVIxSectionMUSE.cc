...
// ********************************************************************
//
// $Id: G4WentzelOKandVIxSectionMUSE.cc 85306 2014-10-27 14:17:47Z gcosmo $
//
// -------------------------------------------------------------------
//
// GEANT4 Class file
//
//
// File name:   G4WentzelOKandVIxSectionMUSE
//
// Author:      V.Ivanchenko 
//
...
#include "G4WentzelOKandVIxSectionMUSE.hh"
...
G4double G4WentzelOKandVIxSectionMUSE::ScreenRSquareElec[] = {0.0};
G4double G4WentzelOKandVIxSectionMUSE::ScreenRSquare[]     = {0.0};
G4double G4WentzelOKandVIxSectionMUSE::FormFactor[]        = {0.0};

using namespace std;

G4WentzelOKandVIxSectionMUSE::G4WentzelOKandVIxSectionMUSE(G4bool combined) :
  numlimit(0.1),
  nwarnings(0),
  nwarnlimit(50),
  isCombined(combined),
...
G4WentzelOKandVIxSectionMUSE::~G4WentzelOKandVIxSectionMUSE()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void G4WentzelOKandVIxSectionMUSE::Initialise(const G4ParticleDefinition* p, 
					  G4double cosThetaLim)
{
  ...
  //G4cout << "G4WentzelOKandVIxSectionMUSE::Initialise  mass= " << mass
  //	 << "  " << p->GetParticleName() 
...
void G4WentzelOKandVIxSectionMUSE::SetupParticle(const G4ParticleDefinition* p)
{
  particle = p;
...
G4double
G4WentzelOKandVIxSectionMUSE::SetupTarget(G4int Z, G4double cut)
{
...
G4double 
G4WentzelOKandVIxSectionMUSE::ComputeTransportCrossSectionPerAtom(G4double cosTMax)
{
  ...
  if(costm < 1.0) {
	...
	G4cout << "G4WentzelOKandVIxSectionMUSE::ComputeTransportCrossSectionPerAtom"
	       << " scattering on e- <0"
	       << G4endl;
	G4cout << "y= " << y 
...
G4ThreeVector&
G4WentzelOKandVIxSectionMUSE::SampleSingleScattering(G4double cosTMin,
						 G4double cosTMax,
						 G4double elecRatio)
{
...
void 
G4WentzelOKandVIxSectionMUSE::ComputeMaxElectronScattering(G4double cutEnergy)
{
  if(mass > MeV) {
...
G4double 
G4WentzelOKandVIxSectionMUSE::ComputeSecondTransportMoment(G4double /*CosThetaMax*/)
{
  return 0.0;
}
