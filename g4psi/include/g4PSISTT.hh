...
class g4PSISTT : public g4PSIDetectorBase {
...
public:
    ...
    g4PSISTT(G4String label, G4double angle, STTChamber stc_part);
    g4PSISTT(G4String label, G4double angle);
    ~g4PSISTT();
...
//    const double dz_planes_ = 0.81*CLHEP::cm;
        const double dz_planes_ = 0.87*CLHEP::cm;
    const double half_straw_spacing_ = 1.01*CLHEP::cm/2.0;
...
//    STTChamber stc_part_;
    ...
    static const int no_of_planes_ = 5;
