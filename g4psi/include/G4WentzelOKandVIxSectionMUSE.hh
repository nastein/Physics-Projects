...
// ********************************************************************
//
// $Id: G4WentzelOKandVIxSectionMUSE.hh 80656 2014-05-06 08:31:39Z gcosmo $
//
// -------------------------------------------------------------------
//
//
...
#ifndef G4WentzelOKandVIxSectionMUSE_h
#define G4WentzelOKandVIxSectionMUSE_h 1
...
class G4WentzelOKandVIxSectionMUSE 
{

public:

  G4WentzelOKandVIxSectionMUSE(G4bool combined = true);

  virtual ~G4WentzelOKandVIxSectionMUSE();
...
private:
  ...
  G4WentzelOKandVIxSectionMUSE & operator=(const  G4WentzelOKandVIxSectionMUSE &right);
  G4WentzelOKandVIxSectionMUSE(const  G4WentzelOKandVIxSectionMUSE&);
...
inline G4double 
G4WentzelOKandVIxSectionMUSE::SetupKinematic(G4double ekin, const G4Material* mat)
{
...
inline void G4WentzelOKandVIxSectionMUSE::SetTargetMass(G4double value)
{
  targetMass = value;
...
inline G4double G4WentzelOKandVIxSectionMUSE::GetMomentumSquare() const
{
  return mom2;
}
...
inline G4double G4WentzelOKandVIxSectionMUSE::GetCosThetaNuc() const
{
  return cosTetMaxNuc;
}
...
inline G4double G4WentzelOKandVIxSectionMUSE::GetCosThetaElec() const
{
...
inline G4double 
G4WentzelOKandVIxSectionMUSE::ComputeNuclearCrossSection(G4double cosTMin,
						     G4double cosTMax)
{
  G4double xsec = 0.0;
  if(cosTMax < cosTMin) {
...
inline G4double 
G4WentzelOKandVIxSectionMUSE::ComputeElectronCrossSection(G4double cosTMin,
						      G4double cosTMax)
{
  G4double xsec = 0.0;
