...
// ********************************************************************
//
// $Id: G4eCoulombScatteringModelMUSE.hh 80656 2014-05-06 08:31:39Z gcosmo $
//
// -------------------------------------------------------------------
//
...
#ifndef G4eCoulombScatteringModelMUSE_h
#define G4eCoulombScatteringModelMUSE_h 1
...
class G4eCoulombScatteringModelMUSE : public G4VEmModel
{

public:

  G4eCoulombScatteringModelMUSE(G4bool combined = true);
 
  virtual ~G4eCoulombScatteringModelMUSE();
...
private:
  ...
  G4eCoulombScatteringModelMUSE & operator=(const G4eCoulombScatteringModelMUSE &right);
  G4eCoulombScatteringModelMUSE(const  G4eCoulombScatteringModelMUSE&);

  //protected:
 
  G4IonTable*               theIonTable;
  G4ParticleChangeForGamma* fParticleChange;
  G4WentzelOKandVIxSectionMUSE* wokvi;
...
inline
void G4eCoulombScatteringModelMUSE::DefineMaterial(const G4MaterialCutsCouple* cup) 
{ 
...
inline 
void G4eCoulombScatteringModelMUSE::SetupParticle(const G4ParticleDefinition* p)
{
...
inline void G4eCoulombScatteringModelMUSE::SetLowEnergyThreshold(G4double val)
{
...
inline void G4eCoulombScatteringModelMUSE::SetRecoilThreshold(G4double eth)
{
  recoilThreshold = eth;
}
...
inline void G4eCoulombScatteringModelMUSE::SetFixedCut(G4double val)
{
  fixedCut = val;
}
...
inline G4double G4eCoulombScatteringModelMUSE::GetFixedCut() const
{
  return fixedCut;
}
