...
RGERegisterModel["2HDM","REAP`RGE2HDM`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGE\[Kappa]1->`Private`Get\[Kappa]1,RGEMd->`Private`GetMd,RGEMe->`Private`GetMe,RGERawM\[Nu]r->`Private`GetRawM\[Nu]r,RGEY\[Nu]->`Private`GetY\[Nu],RGERaw->`Private`GetRawSolution,RGE\[Alpha]->`Private`Get\[Alpha],RGEM\[Nu]->`Private`GetM\[Nu],RGECoupling->`Private`GetCoupling,RGEPoleMTop->`Private`GetPoleMTop,RGEYd->`Private`GetYd,RGEM1Tilde->`Private`GetM1Tilde,RGE\[Lambda]->`Private`Get\[Lambda],RGEM\[Nu]r->`Private`GetM\[Nu]r,RGEAll->`Private`GetSolution,RGEMu->`Private`GetMu,RGERawY\[Nu]->`Private`GetRawY\[Nu],RGEMixingParameters->`Private`GetMixingParameters,RGE\[Kappa]2->`Private`Get\[Kappa]2,RGEYu->`Private`GetYu,RGETwistingParameters->`Private`GetTwistingParameters,RGEYe->`Private`GetYe},
