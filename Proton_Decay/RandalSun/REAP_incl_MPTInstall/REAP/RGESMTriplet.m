...
RGERegisterModel["SMTriplet","REAP`RGESMTriplet`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGE\[Epsilon]->`Private`Get\[Epsilon],RGEYd->`Private`GetYd,RGEYe->`Private`GetYe,RGEM\[CapitalDelta]2->`Private`GetM\[CapitalDelta]2,RGEPoleMTop->`Private`GetPoleMTop,RGEM1Tilde->`Private`GetM1Tilde,RGECoupling->`Private`GetCoupling,RGE\[Lambda]->`Private`Get\[Lambda],RGEMe->`Private`GetMe,RGE\[Epsilon]1Max->`Private`Get\[Epsilon]1Max,RGE\[Alpha]->`Private`Get\[Alpha],RGETwistingParameters->`Private`GetTwistingParameters,RGEMixingParameters->`Private`GetMixingParameters,RGEM\[Nu]->`Private`GetM\[Nu],RGEAll->`Private`GetSolution,RGEY\[Nu]->`Private`GetY\[Nu],RGE\[Kappa]->`Private`Get\[Kappa],RGEM\[Nu]r->`Private`GetM\[Nu]r,RGERawM\[Nu]r->`Private`GetRawM\[Nu]r,RGEMu->`Private`GetMu,RGE\[Epsilon]1->`Private`Get\[Epsilon]1,RGEYu->`Private`GetYu,RGEMd->`Private`GetMd,RGERawY\[CapitalDelta]->`Private`GetRawY\[CapitalDelta],RGERaw->`Private`GetRawSolution,RGERawY\[Nu]->`Private`GetRawY\[Nu],RGE\[Epsilon]Max->`Private`Get\[Epsilon]Max},
