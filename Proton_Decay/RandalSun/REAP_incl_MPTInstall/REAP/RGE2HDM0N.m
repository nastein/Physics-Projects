...
RGERegisterModel["2HDM0N","REAP`RGE2HDM0N`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGE\[Kappa]1->`Private`Get\[Kappa]1,RGEM\[Nu]->`Private`GetM\[Nu],RGETwistingParameters->`Private`GetTwistingParameters,RGERaw->`Private`GetRawSolution,RGEPoleMTop->`Private`GetPoleMTop,RGEYd->`Private`GetYd,RGEYu->`Private`GetYu,RGEMixingParameters->`Private`GetMixingParameters,RGE\[Alpha]->`Private`Get\[Alpha],RGEYe->`Private`GetYe,RGEAll->`Private`GetSolution,RGEM\[Nu]r->`Private`GetM\[Nu]r,RGEMe->`Private`GetMe,RGEMd->`Private`GetMd,RGEMu->`Private`GetMu,RGE\[Kappa]2->`Private`Get\[Kappa]2,RGE\[Lambda]->`Private`Get\[Lambda],RGECoupling->`Private`GetCoupling,RGEY\[Nu]->`Private`GetY\[Nu]},
