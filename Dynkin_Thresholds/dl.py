...
for i in range(0,500):
    ...
    Mv.append(MGUT*(10**rand[0]))
    Mhc.append(MGUT*10**(rand[1]))
    M24t.append(MGUT*10**(rand[2]))
    M24o.append(MGUT*10**(rand[3]))


for j,mu in enumerate(mu_array):
  for i in len(Mv):
    lambda12=lambda_12(Mv[i],Mhc[i],M24t[i],10**mu)
    lambda23=lambda_23(Mv[i],Mhc[i],M24o[i],M24t[i],10**mu)
